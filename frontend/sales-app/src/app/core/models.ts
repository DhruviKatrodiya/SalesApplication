...
export interface Item {
  ...
  name: string; sku?: string; unit?: string; stockQuantity: number; unitPrice: number;
}
...
export interface Customer {
  id: number; name: string; phone?: string; email?: string; address?: string; createdAt: string;
}
